...
<template>
		...
		<div class="background1" id="backgroundCard">
			<section class="spotlight style1 orient-right image-position-center onscroll-image-fade-in" id="first">
				...
				<div class=" d-none d-md-block">
					<div class="d-flex align-items-center justify-content-center" style="min-height: 36vh;">
						<div class="">
							<div class="d-flex justify-content-center  text-white noto-sans-kr-1">
								<h2 class="text4">안녕하세요</h2>
							</div>	
				...
				<div class="d-flex justify-content-center">
					<section>
						<a href="https://github.com/Cappuccino9-K" target="_blank">
							<svg style="fill: white;" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="55" viewBox="0 0 50 50">
				...
				<div class="items style3 small onscroll-fade-in spec1  gap-2 py-5">
					...
					<section>
						<img width="55" height="55" src="https://img.icons8.com/nolan/64/c-sharp-logo.png" alt="c-sharp-logo"/>
					</section>
					<!-- .NET -->
					<section>
						<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="55" X viewBox="0 0 48 48">
					...
					<section>
						<img class="" width="75" height="75" src="/images/icon/winform.webp" alt="" />
					</section>
					<section>
						<img class="" width="55" height="55" src="/images/icon/devexpress.png" alt="" />
					</section>
				</div>
							...
							<div class="w-75 row items small onscroll-fade-in gap-2 mt-3">
								<div class="card card1 col-3">
									<p>
										...
										<div class="d-flex justify-content-between">
											<span class="text-muted">서울특별시경찰청장</span>
								...
								<div class="card card1 col-3 ">
									<p>
										<h6>정보처리산업기사</h6>
										<div class="d-flex justify-content-between">
											<span class="text-muted">한국산업인력공단</span>
											<small class="text-muted">2021.08.20</small>
										</div>
									</p>
								</div>
								<div class="card card1 col-3 ">
									<p>
										<h6>워드프로세서 1급</h6>
										<div class="d-flex justify-content-between">
											<span class="text-muted">대한상공회의소</span>
											<small class="text-muted">2019.05.17</small>
										</div>
									</p>
								</div>
								<div class="card card1 col-3 ">
									<p>
										...
										<div class="d-flex justify-content-between">
											<span class="text-muted">대한상공회의소</span>
											<small class="text-muted">2016.08.19</small>
										</div>
									</p>
								</div>
								<div class="card card1 col-3 ">
									<p>
										<h6>GTQ그래픽기술자격 1급</h6>
										<div class="d-flex justify-content-between">
											<span class="text-muted">한국생산성본부</span>
											<small class="text-muted">2015.09.11</small>
										</div>
									</p>
								</div>
							</div>
							...
							<div class="row d-block d-flex justify-content-center title pb-5 items small onscroll-fade-in">
								<div class="Scriptcontent w-75 mt-3">
									<div class="step">
										...
										<div>
											<div class="title mx-3">2015.03.02~2018.02.21 강서공업고등학교</div>
									...
									<div class="step">
										...
										<div>
											<div class="title mx-3">2018.03~2019.04.04 | 2022.03.02~2023.02.08 한국폴리텍대학 서울강서캠퍼스</div>
											<div class="caption mt-2">
												- 졸업 · 데이터분석과
											</div>
										</div>
									...
									<div class="step step-active">
										...
										<div>
											<div class="title mx-3">2023.03.02~2025.02.17 숭실사이버대학교</div>
											<div class="caption">
												- 졸업 · ICT공학과
											</div>
										</div>
						...
						<div class="row d-block d-flex justify-content-center title pb-5 items small onscroll-fade-in">
							<div class="Scriptcontent w-75 mt-3">
								...
								<div class="step step-active">
									...
									<div>
										<div class="title mx-3">2024.03 ~ 2025.07 황금에스티 IT 전산팀 근무</div>
										<div class="caption">
											- 사내 IT 인프라 관리 및 유지보수<br/>
											- 사용자 기술 지원 및 문제 해결<br/>
											- IT 전산 · 매니저 · ERP
										</div>
									</div>
								</div>
...
onMounted(async () => {
  ...
  await loadScript('/assets/vendor/jquery.scrollex.min.js')
