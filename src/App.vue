		...
		<div id="wrapper" class="divided " style="">
			...
			<div class="w-100" style="min-height: 150px;"> 
					<div class="p-5">
						...
						<div class="row d-block d-flex justify-content-center title">
							<h3 class="jost-font2 text2 w-75 text-end pb-1">PROFILE</h3>
						</div>
						<div class="row d-block d-flex justify-content-center title items small onscroll-fade-in">
						...
						<div class="row d-block d-flex justify-content-center title">
							<h3 class="jost-font2 text2 w-75 text-start pb-1">MY PROJECT</h3>
						</div>
						<div class="row d-block d-flex justify-content-center title pb-5 items small onscroll-fade-in">
							<p class="w-75">asdsad</p>
						</div>
					...
					<section class="spotlight style1 orient-left content-align-left image-position-center onscroll-image-fade-in">
						<div class="content">
								...
								<div class=" d-none d-xl-block">
									<h4 class="jost-font2 text3">PROFILE</h4>
								</div>
							<p>This is also a <strong>Spotlight</strong> element, and it's here because this demo would look a bit empty with just one spotlight. Like all spotlights, you can customize its <span class="demo-controls">appearance with a number of modifiers</span>, as well as assign it an optional <code>onload</code> or <code>onscroll</code> transition modifier (<a href="#reference-spotlight">details</a>).</p>
							<ul class="actions stacked">
